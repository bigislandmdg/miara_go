...
export const resources = {
  fr: {
    ...
    // ================= RIDE REQUEST =================
      ...
      withdraw: "Retirer",
      all: "Tout",
      creditPurchases: "Achat de crédits",
      add: "Ajouter",
      ...
      withdrawDescription: "Retrait",
      creditPurchaseDescription: "Achat de crédits",
      earningDescription: "Gain de trajet",
      ...
      expired: "Expiré",
      close: "Fermer",
      walletQR: "Portefeuille QR",
      qrGenerationFailed: "Génération du QR échouée",
      qrInvalidOrExpired: "QR invalide ou expiré",
      qrScanFailed: "Scan du QR échoué",
      qrScanned: "QR scanné",
  ...
  securities: {
    ...
    security4Desc: "Une équipe disponible pour vous assister à tout moment"
      ...
      inviteDesc: "Partagez MiaraGo avec vos amis",
      inviteMessage: "Rejoins-moi sur MiaraGo pour voyager ensemble ! 🚗 Télécharge l'application ici : https://miarago.com/download",
      personalInfoDesc: "Vos informations personnelles",
      paymentMethodsDesc: "Gérez vos moyens de paiement",
      savedPlacesDesc: "Domicile, Travail, Lieux favoris",
      ...
      languageDesc: "Français, English, Malagasy",
      helpCenterDesc: "FAQ, tutoriels, assistance",
  ...
  en: {
    ...
    add: "Add",
    all: "All",
    creditPurchases: "Credit purchase",
    loadMore: "Load more",
    ...
    creditPurchaseDescription: "Credit purchase",
    earningDescription: "Trip earning",
    ...
    qrInvalidOrExpired: "Invalid or expired QR",
  ...
  securities: {
    ...
    security4Desc: "A dedicated team available to assist you anytime"
      ...
      inviteDesc: "Share MiaraGo with your friends",
      inviteMessage: "Join me on MiaraGo to travel together! 🚗 Download the app here: https://miarago.com/download",
  
      personalInfoDesc: "Your personal information",
      paymentMethodsDesc: "Manage your payment methods",
      savedPlacesDesc: "Home, Work, Favorite places",
      notificationsDesc: "Alerts and reminders",
      privacyPolicyDesc: "How we protect your data",
      securityDesc: "Two-factor authentication",
      languageDesc: "French, English, Malagasy",
      helpCenterDesc: "FAQ, tutorials, support",
  ...
  mg: {
    translation: {
      ...
      createTrip: "Mamorona dia",
      searchTrip: "Mitady dia",
      publishTrip: "Mamoaka",
    ...
    add: "Hanampy",
    all: "Izy rehetra",
    creditPurchases: "Fahana novidina",
    ...
    withdrawDescription: "Famoahana",
    creditPurchaseDescription: "Fividianana crédit",
    earningDescription: "Fahazoana dia",
    withdrawals: "Famoahana",
    ...
    seeAll: "Jereo daholo",
    showLess: "Aseho",
    deleteTransactionMessage: "Tsy azo averina intsony ity hetsika ity.",
    thisWeek: "Ity herinandro ity",
    thisMonth: "Ity volana ity",
    earningsSummary: "Famintinana ny fahazoana",
    totalEarned: "Totalin'ny azo",
    totalWithdrawn: "Totalin'ny noesorina",
    net: "Tombony",
    at: "amin'ny",
    ref: "Réf",
    myQRCode: "Ny QR Code-ko",
    expired: "Lany daty",
    close: "Hidio",
    walletQR: "Poketra QR",
    qrGenerationFailed: "Tsy nahomby ny famoronana QR",
    qrInvalidOrExpired: "QR tsy mety na lany daty",
    qrScanFailed: "Tsy nahomby ny scan QR",
    qrScanned: "QR voasana",
  ...
  securities: {
    ...
    security4Desc: "Ekipa vonona hanampy anao amin'ny fotoana rehetra"
      ...
      invite: "Manasa namana",
      inviteDesc: "Zarao MiaraGo amin'ny namanao",
      inviteMessage: "Manatehina ahy amin'ny MiaraGo hizara dia! 🚗 Alao ny fampiharana eto: https://miarago.com/download",
      personalInfoDesc: "Ny mombamomba anao",
      paymentMethodsDesc: "Ampio ny fandoavana",
      savedPlacesDesc: "Trano, Asa, Toerana tianao",
      notificationsDesc: "Fampandrenesana",
      privacyPolicyDesc: "Ahoana ny fiarovana ny mombamomba anao",
      securityDesc: "Fiarovana roa dingana",
      languageDesc: "Frantsay, Anglisy, Malagasy",
      helpCenterDesc: "Fanampiana sy torolalana",
      contactDesc: "Mifandraisa aminay",
      guides: {
         content: "Torolalana sy fampianarana hampiasana tsara ny application",
